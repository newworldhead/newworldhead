...
export default function Stength({ currentPoints, setCurrentPoints, focus, setFocus }) {

    let percentage = (focus / 300) * 100
            ...
            <div className="w-full px-4 md:px-10" >
                <div>
                    <div className="flex flex-row gap-2 items-center">
                        <h3 className="text-white uppercase text-xl tracking-widest font-primary">focus</h3>
                        <span className="italic text-white tracking-widest text-xs">(healing focused)</span>
