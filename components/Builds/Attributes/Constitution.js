...
export default function Stength({ currentPoints, setCurrentPoints, constitution, setConstitution }) {

    let percentage = (constitution / 300) * 100

    const handleBackBig = () => {
        setConstitution(constitution - 5)
        ...
        <div className="flex flex-col md:flex-row items-center bg-secondary py-4 md:px-8 md:my-0">
            ...
            <div className="grid grid-cols-3 justify-items-center w-1/5 place-items-center mb-4 md:mb-0" >
                ...
                <div className="flex items-center">
                    <h2 className="text-4xl text-white">{constitution}</h2>
                </div>
            ...
            <div className="w-full px-4 md:px-10" >
                <div>
                    <div className="flex flex-row gap-2 items-center">
                        <h3 className="text-white uppercase text-xl tracking-widest font-primary">constitution</h3>
                        <span className="italic text-white tracking-widest text-xs">(health focused)</span>
